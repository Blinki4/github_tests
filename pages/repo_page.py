...
class RepoPage(BasePage):
    ...
    start_delete_repo_button_selector = (By.CSS_SELECTOR, '.js-repo-delete-button')
    ...
    @property
    def start_delete_repo_button(self):
        return self.wait_element(EC.element_to_be_clickable(self.start_delete_repo_button_selector))


    def click_start_delete_repo_button(self):
        self.start_delete_repo_button.click()