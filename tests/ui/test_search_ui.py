...
class TestSearchUI:
    ...
    def test_search_linux_repo(self, main_page, search_page):
    ...
    def test_search_user_repo(self, main_page, search_page):
    ...
    def test_open_search_with_hotkey(self, main_page):
    ...
    def test_empty_results(self, main_page, search_page):
    ...
    def test_empty_search_query(self, main_page, search_page):
        main_page.search('')
