...
class TestSearchUI:
    ...
    def test_empty_results_ui(self, main_page, search_page):
    ...
    def test_empty_search_query_ui(self, main_page, search_page):
        main_page.search('')
