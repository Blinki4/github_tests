...
def test_redirect_to_new_repo_page(create_repository_ui, new_repo_page, delete_repository_req):
...
def test_new_repo_title_displayed(create_repository_ui, repo_page, delete_repository_req):
...
def test_new_private_repo(new_repo_page, repo_page, delete_repository_req):
...
def test_delete_repo(create_repository_ui, repo_page):
