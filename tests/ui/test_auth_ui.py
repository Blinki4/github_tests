...
class TestAuthUI:
    ...
    def test_redirect_to_main_page_after_sign_in_ui(self, authorized_page):
        assert authorized_page.home_title_is_displayed

    @pytest.mark.ui
    @allure.title('Проверка имени пользователя после авторизации')
    def test_sign_in_ui(self, authorized_page):
    ...
    def test_auth_with_invalid_password_ui(self, login_page):
